...
window.__SIGTS_WILDLIFE_TOUR_THEMES_FALLBACK__ = [
    {
        ...
        tourist_summary_en:
            'This block keeps every taxonomic chapter in play: great apes anchor attention, but birds, butterflies, trees, and small mammals complete why Bwindi is a global conservation priority. Use it when you have time on the trail between focal sightings.',
        guide_script_en:
            'Frame the walk as chapters: primates first for emotional hook, then birds or plants by ear and light, then large mammals as bonus scenes. Remind guests silence is a tool; sound reveals what eyes miss. Close by linking their permit fees to monitoring, community revenue, and law enforcement that keep this forest intact.',
        talking_points: [
        ...
        safety_notes:
            'General rule: stay behind the lead ranger, do not leave the line, and announce stumbles loudly enough that the rear guard hears.',
        etiquette_notes:
    ...
    },
    {
        ...
        tourist_summary_en:
            "Mountain gorillas are the headline species, yet l'Hoest's monkeys, other cercopithecids, and occasionally chimpanzees appear in vignettes depending on sector and habituation. Guests learn why primate-centered tourism finances protection but also concentrates human pressure.",
        guide_script_en:
            'Open by naming the trekking rules already in briefing: masks when required, distance, coughing protocol, no feeding. Pivot to monkeys: fast, perpendicular sight lines, listen for cascading alarm calls rippling uphill. Mention researchers track health bridges between villagers and gorillas; your hygiene matters.',
        talking_points: [
        ...
        safety_notes:
            'Keep Uganda Wildlife Authority separation. Never touch primates; disease moves both ways. If animals close in, follow the lead ranger’s slow step back drill.',
        etiquette_notes:
    ...
    },
    {
        ...
        tourist_summary_en:
            'Forest elephants carve trails, mineral seeps cue drama, buffalo or duiker sightings punctuate quieter hiking. Probability varies. Position this module as stewardship listening, not a zoo guarantee.',
        guide_script_en:
            'Describe toe-print versus round hoof, dung crumble for browsing versus fibrous grazing, snapped saplings waist-high versus shoulder-high. Invite guests to imitate tracker cadence: pause every 80 to 100 metres to scan acoustically.',
        talking_points: [
        ...
        safety_notes:
            'Never wedge between calves and adults; lateral retreat upslope beats running downhill where footing fails.',
        etiquette_notes:
    ...
    },
    {
        ...
        tourist_summary_en:
            'This session trains ears: green broadbill hoots, warbler chatter in swamp tangles, flycatchers sallying shaded gaps. Albertine Rift speciality is why many guests pack serious optics. Even short canopy vistas reward patience.',
        guide_script_en:
            'Chunk time: twelve minutes stationary listening, eight minutes creeping to the next acoustic window. Rotate narration so photographers get windows without chatter overlap. Mention altitudinal layering: some species cling to moss belts others avoid.',
        talking_points: [
        ...
        safety_notes:
            'Watch footing on wet logs while staring up. Use a buddy shoulder tap before someone steps backward blind.',
        etiquette_notes:
    ...
    },
    {
        ...
        tourist_summary_en:
            'Butterflies map microclimate: muddy seeps after rain, sunflecks on landslide scars, ridges that vent warm moist air midday. Tie human behaviour (where we stand shading puddles) to ethical viewing.',
        guide_script_en:
            'Invite guests to note flight height: swallowtails often beat higher than blues or skippers. Mention hilltopping sparingly; it excites naturalists without overpromising. Connect larvae hosts with trail side vines rangers survey.',
        talking_points: [
        ...
        safety_notes:
            'Ledges near sun gaps are slick. Plant poles before lunging toward frame-filling snaps.',
        etiquette_notes:
    ...
    },
    {
        ...
        subtitle:
            'When sightings are thin, credit patrols and habitat work instead of filling silence with guesses',
        tourist_summary_en:
            'Many marquee species carry IUCN Red List statuses; this session reframes success as evidence of protection (silent forest can mean avoidance, not emptiness). Connect tourism to ranger patrol arcs, canine units, and corridor diplomacy.',
        guide_script_en:
            'Script honesty: sightings are stochastic. Celebrate wins guests funded: sanctioned clinics, classrooms, roadside snare removal totals from UWA or community cooperatives when numbers are verified.',
        talking_points: [
        ...
        safety_notes:
            'Do not scramble downslope chasing silhouettes beyond posted limits. Vertical rescue beats ego.',
        etiquette_notes:
